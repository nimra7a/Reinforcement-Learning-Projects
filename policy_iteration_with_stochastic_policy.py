...
actions = ["Drive", "No Drive"]  # List of available actions
...
# ===========================
# Stochastic Initial Policy (Random Selection)
# ===========================

# Initialize a random policy by selecting a random action for each state
stochastic_policy = {s: np.random.choice(actions) for s in states}

print("\nStarting Policy Iteration with Stochastic Random Policy...\n")
optimal_values, optimal_policy = policy_iteration(stochastic_policy)
